...
namespace SiteD.Common
{
    ...
    public class Jscript
    {
        ...
        /// <summary>
        /// 跳转页面parent.frames.location.href
        /// </summary>
        ...
        public static void RedirectToFrames(string url)
        {
            HttpContext.Current.Response.Write("<script>window.top.mainFrame.location.href='" + url + "'</script>");
        }
