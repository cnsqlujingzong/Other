...
namespace SiteD.DBUtility
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source = " + System.Web.HttpContext.Current.Server.MapPath("~/App_Data/Database.mdb");
