<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JXHJ2.aspx.cs" Inherits="cpage_jxhj2" %>
       ...
       <div style="width: 900px; margin: 0px auto">
            ...
            <div>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td  width="30%" align="right">奖项名称:</td>
                        ...
                        <td  width="*" align="left">
                            <asp:DropDownList ID="ddl_cbtype" runat="server" Width="200px" >
                                <asp:ListItem Value="1" Selected="True">省部委级</asp:ListItem>
                                <asp:ListItem Value="5">国家级别</asp:ListItem>                                             
                            </asp:DropDownList>
                                                        
                        </td>
                    </tr>  
                        <tr>
                        <td  width="30%" align="right">奖项：</td>
                        <td  width="*" align="left">
                            <asp:DropDownList ID="ddl_ptype" runat="server" Width="200px" >
                                <asp:ListItem Value="600">一等奖</asp:ListItem>
                                <asp:ListItem Value="300">二等奖</asp:ListItem>
                                <asp:ListItem Value="100">三等奖</asp:ListItem>
                                <asp:ListItem Value="80">四等奖</asp:ListItem>                       
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td  width="*" align="left" class="auto-style2">
                            <asp:DropDownList ID="ddl_cg" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_cg_SelectedIndexChanged"  >
