<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XKJS.aspx.cs" Inherits="cpage_XKJS" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 900px; margin: 0px auto">
            <h3 style="text-align:center">学科竞赛</h3>
                    ...
                    <tr>
                        ...
                        <td  width="*" align="left">
                            <asp:DropDownList ID="ddl_ptype" runat="server" Width="200px">
                                <asp:ListItem>校级奖励</asp:ListItem>
                                <asp:ListItem>市级奖励</asp:ListItem>
                                <asp:ListItem>国际组织奖励</asp:ListItem>
                                <asp:ListItem>国家级奖励</asp:ListItem>
                            </asp:DropDownList>

                        </td>
                    </tr>
                         <tr>
                        <td  width="30%" align="right">获奖情况：</td>
                        <td  width="*" align="left">
                            <asp:RadioButtonList ID="rb_status" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="一等奖" Selected>一等奖</asp:ListItem>
                                <asp:ListItem Value="二等奖">二等奖</asp:ListItem>
                                <asp:ListItem Value="三等奖">三等奖</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>                        
                    </tr>
                   
                        <tr>
                        <td  width="30%" align="right">获得全国挑战杯：</td>
                        <td  width="*" align="left">
                             <asp:RadioButtonList ID="rb_istzb" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
                                <asp:ListItem Value="是" >是</asp:ListItem>
                                <asp:ListItem Value="否" Selected>否</asp:ListItem>                                
                            </asp:RadioButtonList>
                             <asp:RadioButtonList ID="rb_tzb_jl" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="特等奖" >特等奖</asp:ListItem>
                                   <asp:ListItem Value="一等奖">一等奖</asp:ListItem>
                                <asp:ListItem Value="二等奖">二等奖</asp:ListItem>
                                <asp:ListItem Value="其他" Selected>其他</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>  
                       <tr>
                        <td  width="30%" align="right">工作量比例：</td>
                        <td  width="*" align="left">
                              <asp:TextBox ID="txtTGetScore" runat="server" Width="200px"></asp:TextBox>&nbsp; 比例为0~1之间<br />
                        </td>
                    </tr>  
                       <tr>
