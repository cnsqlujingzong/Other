<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JXGG.aspx.cs" Inherits="cpage_JXGG" %>
...
<body>
    <form id="form1" runat="server">
       <div style="width: 900px; margin: 0px auto">
            <h3 style="text-align:center">教学研究相关项目（综合课改、课程建设、教改）</h3>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td  width="*" align="left"> <asp:TextBox ID="txtProjectName" runat="server" Width="200px"></asp:TextBox> </td>
                          ...
                          <tr>
                        <td  width="30%" align="right">项目分类：</td>
                        <td  width="*" align="left">   <asp:DropDownList ID="ddl_pc" runat="server" Width="200px" >
                             <asp:ListItem >课程建设</asp:ListItem>
                             <asp:ListItem >教材建设</asp:ListItem>
                             <asp:ListItem >教改项目</asp:ListItem>
                             <asp:ListItem >校级教改</asp:ListItem>
                                                       </asp:DropDownList> </td>
                    </tr>  
                        <tr>
                        ...
                        <td  width="*" align="left">
                            ...
                            教师1：<asp:TextBox ID="txtJS1" runat="server" Text=""></asp:TextBox>贡献比例:<asp:TextBox ID="txt_js1_lv" runat="server" Text=""></asp:TextBox><span style="color:red">范围0~1</span><br />
                            教师2：<asp:TextBox ID="txtJS2" runat="server" Text=""></asp:TextBox>贡献比例:<asp:TextBox ID="txt_js2_lv" runat="server" Text=""></asp:TextBox><span style="color:red">范围0~1</span><br />
                            教师3：<asp:TextBox ID="txtJS3" runat="server" Text=""></asp:TextBox>贡献比例:<asp:TextBox ID="txt_js3_lv" runat="server" Text=""></asp:TextBox><span style="color:red">范围0~1</span><br />
                            教师4：<asp:TextBox ID="txtJS4" runat="server" Text=""></asp:TextBox>贡献比例:<asp:TextBox ID="txt_js4_lv" runat="server" Text=""></asp:TextBox><span style="color:red">范围0~1</span><br />
