                ...
                <div style="padding: 10px 0 0 25px; font-size: 12px; color: #fff;">
                    <table width="50%" border="0" cellspacing="0" cellpadding="3" align="center">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;<asp:Label ID="lb_msg" runat="server" ForeColor="Red"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <input src="images/login_submit.gif" name="Image1" type="image" id="Image1" runat="server" onserverclick="Image1_ServerClick" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
