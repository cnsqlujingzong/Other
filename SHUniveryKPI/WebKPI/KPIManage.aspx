<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPIManage.aspx.cs" Inherits="KPIManage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="padding-top:20px">
            ...
            <div id="tb_dxscx" class="content" style="display:none">
               <a href="/cpage/AddCXSY.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加创新实验项目</a>               
                 ...
                 <div id="TableXKJS" class="content" style="display:none">
                       <a href="/cpage/XKJS.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加学科竞赛</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
          ...
          <h3  class="titleBar" href="#TableDSZ" style="">本科班导师、励志导师和学术导师</h3>
                 <div id="TableDSZ" class="content" style="display:none">
                       <a href="/cpage/DSZ.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加导师项目</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
         ...
         <h3  class="titleBar" href="#TableJXGG" style="">教学改革项目，课程建设和获奖项目</h3>
                 <div id="TableJXGG" class="content" style="display:none">
                       <a href="/cpage/JXGG.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加教学改革项目</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                          ...
                          <a href="/cpage/JXHJ2.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加教学获奖</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <asp:Repeater ID="rp_jxhj" runat="server">
                                ...
                                <td><%#Eval("ProjectNO")%></td>
                                 ...
                                 <td><%#Convert.ToInt32(Eval("float2"))%></td>
                                 <td><%#Eval("Str1")%></td>    
                                 <td><a href="cpage/JXHJ2.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=edit">编辑</a> <a href="cpage/JXHJ2.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=del" onclick="return confirm('确定要删除')">删除</a></td>
                          ...
                          <a href="/cpage/JXLW.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加教学论文</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
              ...
              <h3  class="titleBar" href="#TableKYXM" style="">科研项目</h3>
                 <div id="TableKYXM" class="content" style="display:none">
                       <a href="/cpage/KYXM.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加科研项目</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
          ...
          <h3  class="titleBar" href="#TableKYLW" style="">科研论文</h3>
                 <div id="TableKYLW" class="content" style="display:none">
                       <a href="/cpage/LW.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加科研论文</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <asp:Repeater ID="rp_KYLW" runat="server">
                                ...
                                <td><%#Eval("ProjectNO")%></td>
                                 ...
                                 <td><%#Convert.ToInt32(Eval("float2"))%></td>
                                 <td><%#Eval("Str1")%></td>    
                                 <td><a href="cpage/LW.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=edit">编辑</a> <a href="cpage/LW.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=del" onclick="return confirm('确定要删除')">删除</a></td>
                 ...
                 <div id="TableKYCB" class="content" style="display:none">
                       <a href="/cpage/CB.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加著作出版</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <asp:Repeater ID="rp_KYCB" runat="server">
                                ...
                                <td><%#Eval("ProjectNO")%></td>
                                 ...
                                 <td><%#Convert.ToInt32(Eval("float2"))%></td>
                                 <td><%#Eval("Str1")%></td>    
                                 <td><a href="cpage/CB.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=edit">编辑</a> <a href="cpage/CB.aspx?id=<%#Tid%>&&cxsyid=<%#Eval("ID") %>&&op=del" onclick="return confirm('确定要删除')">删除</a></td>
                 ...
                 <div id="TableKJJL" class="content" style="display:none">
                       <a href="/cpage/KJ.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加科技奖励</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
               ...
               <h3  class="titleBar" href="#TableZL" style="">获得专利</h3>
                 <div id="TableZL" class="content" style="display:none">
                       <a href="/cpage/ZL.aspx?id=<%=Tid%>" class="button button-royal button-rounded button-giant">+添加专利</a>               
                  <div class="grid" style="padding-bottom:30px">
                    <table border="1" cellpadding="0" cellspacing="0" class="mainTable">
                        <thead>
                            <tr>
